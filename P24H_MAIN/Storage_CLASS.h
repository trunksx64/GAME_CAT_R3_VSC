...
#define FSC_CLOCK_SYSTEM (uint32_t)(40000000UL)
...
#define WDTCLR()                __builtin_clrwdt()
#define SLEEP()                 __builtin_pwrsav(0U)
#define IDLE()                  __builtin_pwrsav(1U)
#define RESET()                 __asm__ volatile("RESET")

#if __DEBUG
#define pdNOP()                 __builtin_nop()
#else
#define pdNOP()
#endif
